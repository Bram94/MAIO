...
for i in range(8,9):
    ...
    gw.dates, gw.hours, gw.V_g, gw.V_g_interpolated = gw.run()
    ...
    def plot_windprofiles(ax, j):
        ...
        for i in range(len(plot_hours)):
            ...
            u_g = gw.V_g_interpolated[j, time_index, 0]; v_g = gw.V_g_interpolated[j, time_index, 1]
    ...
    def plot_windcycles(ax, j):
        ...
        u_g = gw.V_g_interpolated[j, :, 0]; v_g = gw.V_g_interpolated[j, :, 1]    
